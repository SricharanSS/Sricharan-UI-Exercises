 ...
 const locationList = [
  ...
  for(const element of locationList) {
    if(element.country == "United States") {
        flag = "img/united-states.png";
    }
    else if(element.country == "India") {
        flag = "img/India.png";
    }
    else if(element.country == "Canada") {
        flag = "img/canada.png";
    }
    locations.innerHTML += "<tr> <td> <img src=' "+flag+" ' /> </td> <td> "+element.state+" </td> <td> "+element.city+" </td> <td> "+element.contact+" </td> </tr>";
  }